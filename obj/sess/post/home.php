<?php
 ...
 /*************************************************************************************
  This is the posts landing page routine. A registered user has clicked "Bulletins" on
  the left-hand nav bar, meaning that they wish to do something with Posts.
  Either they will search for an existing post, read it, reply to it, or they will create
  a new post of their own. The default view is a roster of all existing posts.
 ...
 debug_log_inputs('post-home', $_POST);

 if(strcmp($send_request, 'hearYEEHEARyee') == 0)				#  Run only if request came from JS
   {
 ...
 debug_log_outputs('post-home', $outputstring);
